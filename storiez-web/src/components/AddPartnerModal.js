...
function AddPartnerModal({ partnerOpen, yesPartner }) {
  ...
  return (
    <Modal
      isOpen={partnerOpen}
      className="p-4 border flex h-screen text-center"
    >
      <div className=" border w-96 m-auto p-4 bg-white">
        ...
        <div className="flex flex-col items-center">
          <p className="text-sm text-left">
            <strong>Note</strong>: Partners can only view your notes, and cannot
          ...
          <div className="my-4 gap-5 text-center">
            ...
            {msg ? (
              <p className="mb-2 text-green-600">
                <strong>{msg} </strong>is now your friend
              </p>
            ) : null}
            ...
            <div className="flex items-center">
              ...
              <button
                className="bg-black text-white flex-1 rounded-sm py-1 px-2"
                onClick={() => addPartner()}
              >
                {loading ? (
                  <RefreshIcon className="h-6 mx-auto p-0 " />
                ) : (
                  "Add Partner"
                )}
              </button>
